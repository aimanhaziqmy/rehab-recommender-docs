...
const config = {
  title: 'Recommendation system for cardiac rehabilitation',
  tagline: 'Secondary prevention for CVD',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} MyCardiacRehab, build with passion and love.`,
      },
      prism: {
